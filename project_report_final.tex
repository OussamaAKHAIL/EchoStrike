...
This project is developed under the open-source product name \textbf{EchoStrike}. The complete source code, models, and visualization scripts are publicly available at the official repository: \url{https://github.com/OussamaAKHAIL/EchoStrike}.
...
\begin{figure}[H]
\centering
    \includegraphics[width=0.6\textwidth]{media/10_keys.png}
    \caption{The 10 numeric keys (0-9) targeted during the intermediate multi-class scaling phase.}
\end{figure}
...
\begin{figure}[H]
\centering
    \includegraphics[width=0.8\textwidth]{media/hyper_parameters_10_keys.png}
    \caption{Evolution of the minimum objective error during Bayesian Hyperparameter Optimization for the 10-key model.}
\end{figure}
...
\begin{figure}[H]
\centering
    \includegraphics[width=0.7\textwidth]{media/confusion_matrix_10_keys.png}
    \caption{Confusion Matrix for the 10 numeric keys showing 73.20\% accuracy.}
\end{figure}
...
\begin{figure}[H]
\centering
    \includegraphics[width=1\textwidth]{media/full_confusion_matrix.png}
    \caption{104-Class Full Keyboard Confusion Matrix (Accuracy: 71.04\%)}
\end{figure}
...
\begin{figure}[H]
\centering
    \includegraphics[width=0.8\textwidth]{media/3D_PCA.png}
    \caption{Principal Component Analysis (1000D to 3D scatter visualization)}
\end{figure}
...
\begin{figure}[H]
\centering
    \includegraphics[width=1\textwidth]{media/result_visualisation.png}
    \caption{Immersive 2D Topographic Probabilistic Layout of the True Key position}
\end{figure}
